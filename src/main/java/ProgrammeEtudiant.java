...
public class ProgrammeEtudiant
{
    public static void main (String [] args) { 
        ...
        adrs.rue = 9;
        adrs.nomRue = "rue Richshoffer";
        adrs.codePostal = "67100";
        adrs.ville = "Strasbourg";
        
        afficheAdresse(adrs);
        
        Adresse adrs2;
        adrs2 = new Adresse(6, "Allée du val d'Aran", "31770", "Colomiers");
        
        afficheAdresse(adrs2);
            ...
            for(int i = 0; i < nbEtudiants; i++) {
              ...
              afficheAdresse(tabInfo[i].adrss);
            }
        
            for(int i = 0; i < nbEtudiants; i++) {
              System.out.println("Nom : "+tabInfo[i].nom + " prénom " +tabInfo[i].prenom+ " adresse " + tabInfo[i].adrss.rue);
            }
        
            for(int i = 0; i < nbEtudiants; i++) {
              System.out.println("Nom : "+tabInfo[i].nom + " prénom " +tabInfo[i].prenom+ " adresse " + tabInfo[i].adrss);
            }
        
        
    }
    
    public static void afficheAdresse(Adresse adrs) {
       System.out.println("Adresse : " +adrs.rue+" "+adrs.nomRue+" - "+adrs.codePostal+" "+adrs.ville);
    }
}
